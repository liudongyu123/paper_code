...
from .base.attention import CBAM,SE # 1、调用注意力机制模块
from .base.network_blocks import BaseConv, CSPLayer, DWConv, Focus, ResLayer, SPPBottleneck
...
class ShuffleNetV2(BaseBackbone):
    ...
    def forward(self, x):
        ...
        # outs[0] = self.cbam_1(outs[0])
        # outs[1] = self.cbam_2(outs[1])
        # outs[3] = self.cbam_3(outs[2])
        return tuple(outs)
